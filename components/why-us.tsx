...
const features = [
  {
    ...
    description:
      'Каждая коллекция создаётся с вниманием к актуальным трендам и вечной классике. Мы предлагаем образы, которые подчёркивают индивидуальность.',
    icon: (
  ...
  },
  {
    ...
    description:
      'Мы тщательно отбираем поставщиков и материалы. Натуральные ткани, продуманный крой и отличная обработка швов — наш стандарт.',
    icon: (
      <svg width="28" height="28" viewBox="0 0 32 32" fill="none" aria-hidden="true">
  ...
  },
  {
    ...
    description:
      'Доставляем по всему Казахстану. Курьерская доставка, самовывоз или почта — выбирайте удобный способ получения заказа.',
    icon: (
      <svg width="28" height="28" viewBox="0 0 32 32" fill="none" aria-hidden="true">
